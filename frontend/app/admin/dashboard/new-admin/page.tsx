...
export default function AddNewAdminPage() {
    ...
    return (
        <>
            <h1 className='p-5 text-3xl font-bold text-[#8884d8]'>Dodaj admina: <span className='text-white font-semibold'>{user.name}</span></h1>
                    ...
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className='py-4 px-10'>
                            ...
                            <div className='w-full flex justify-end gap-5 mt-6'>
                                <Button type="button" className="flex  rounded-xl bg-[#8884d8] hover:bg-[#a6a1f7] text-white hover:text-white/90 duration-300 ease-in-out" onClick={() => router.push('/admin/dashboard')}>Powrót</Button>
                                <Button type="submit" className="flex  rounded-xl bg-[#8884d8] hover:bg-[#a6a1f7] text-white hover:text-white/90 duration-300 ease-in-out">Dodaj</Button>
                            </div>
                        </form>
                    </Form>
                )}
